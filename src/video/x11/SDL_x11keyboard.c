...
static const struct {
    ...
    { XK_ISO_Level5_Shift, SDL_SCANCODE_MODE },
    ...
    { XK_Hangul, SDL_SCANCODE_LANG1 },
    { XK_Hangul_Hanja, SDL_SCANCODE_LANG2 },
    { XK_Hiragana_Katakana, SDL_SCANCODE_INTERNATIONAL2 },
    { XK_Henkan_Mode, SDL_SCANCODE_INTERNATIONAL4 },
    { XK_Muhenkan, SDL_SCANCODE_INTERNATIONAL5 },
